...
Route::middleware(['auth:sanctum', 'verified'])->get('/dashboard', [ChatController::class, 'getDashboard'])->name('dashboard');

Route::middleware(['auth:sanctum', 'verified'])->get('/chat/{team_id}', [ChatController::class, 'chatRoom'])->name('chatroom');

Route::middleware('auth:sanctum')->get('chat/{team_id}/rooms', [ChatController::class, 'chatRooms']);
...
Route::middleware('auth:sanctum')->get('/teams', [ChatController::class, 'Teams']);
Route::middleware('auth:sanctum')->post('/add-member/{team_id}', [ChatController::class, 'addMember']);
